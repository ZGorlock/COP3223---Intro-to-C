...
////Other Examples
////08-20-2014
////Other examples from Chapter 2 with Scanf
//
//#include <stdio.h>
//#include <stdlib.h>
//
...
//
//  printf("Grants:");
//  scanf("%f", &finaid_grants);
//
//  printf("Loans:");
//  scanf("%f", &finaid_loans);
//
//  printf("Grandma's Money:");
//  scanf("%f", &grandma_total);
//
//  printf("Grandma's Kids:");
//  scanf("%f", &grandma_kids);
//
//  //calculations
